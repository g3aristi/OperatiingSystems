...
('Number of memory accesses in algorithm component of the program:', 5055)
			...
			Task 2
The tables prepared in Task 2, along with two paragraphs. 


The first paragraph should compare the various heuristics in terms of 
...
the data you obtained for LRU as the size of memory increases.
...
and ration per doubleing memory is, from 50 to 100 is 0.712, 
from 100 to 150 is 0.698, from 150 to 200 is 0.698

simpleloop memsieze  50		100		150 		200
...
Miss rate: 	  0.0055		0.0044	
			...
			Task 3
A paragraph explaining the how the trace from Task 3 illustrates Belady's anomaly. 
Make reference to the hit rate in each case.
